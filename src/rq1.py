...
df_rail_truncated = df_rail_complete[['test_suite', 'test_suite_start time', 'test_suite_duration', 'test_suite_failures', 'test_suite_errors',
                                      'job_id', 'job_number', 'job_start_time', 'job_env', 'job_rvm',
                                      'build_id', 'build_number', 'build_status' ]]

df_rail_clean_onets = df_rail_complete.loc[df_rail_complete['test_suite'] == 'railties/test/application/asset_debugging_test.rb']
