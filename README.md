...
You could use Ruby on Rails to do the evaluation, but just would need to check how explicit the test suite execution/success/failure data is in the build logs (which you would need to download).
...
About downloading the build logs you are referring to these logs, right?
